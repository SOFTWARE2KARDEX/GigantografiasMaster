 ...
 * @author HENRY
 */
public class frmvistaplancha extends javax.swing.JFrame {

    /**
     * Creates new form frmvistaplancha
     */
    public frmvistaplancha() {
        initComponents();
        mostrar("");
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount()==2) {
            ...
            frmdetallesalida.txtidplancha.setText(cod);
            frmdetallesalida.txtplancha.setText(valor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistaplancha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistaplancha().setVisible(true);
            }
        });
    }
